...
version <- unlist(
    strsplit(unlist(strsplit(basename(package_tarball), "mspbwt_")), ".tar.gz")
)

## move tarball to releases
release_package_tarball <- file.path("releases", paste0("mspbwt_", version, ".tar.gz"))
...
## pdf_name <- file.path("releases", paste0("mspbwt_", version, ".pdf"))
## args = c(
